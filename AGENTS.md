...
- Experience themes, semantic sound feedback, and confirmation-action roles are documented in `docs/experience-themes.md`. Keep lifecycle code emitting `AppSoundFeedbackEvent`, and use `ConfirmationActionButton` instead of assigning approval colors in individual views.
